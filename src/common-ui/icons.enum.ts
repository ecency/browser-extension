...
/**
 * Short names used by tests and legacy UI strings (`data-testid` prefixes).
 * Prefer `SVGIcons` in application code.
 */
export const Icons = {
  PREFERENCES: SVGIcons.MENU_USER_PREFERENCES,
  AUTHORIZED_OPERATIONS: SVGIcons.MENU_USER_PREFERENCES_OPERATIONS,
  ...
  IMPORT: SVGIcons.MENU_ADVANCED_SETTINGS_IMPORT_SETTINGS,
  EXPORT: SVGIcons.MENU_ADVANCED_SETTINGS_EXPORT_SETTINGS,
  ACCOUNTS: SVGIcons.MENU_ACCOUNTS,
  /** Settings → Governance (menu item icon key for `data-testid`) */
  GOVERNANCE: SVGIcons.MENU_GOVERNANCE,
  MANAGE_ACCOUNTS: SVGIcons.MENU_ACCOUNTS_MANAGE_ACCOUNTS,
  DELEGATIONS_HP: SVGIcons.WALLET_HP_DELEGATIONS,
  HISTORY: SVGIcons.WALLET_HISTORY_BUTTON,
  RPC: SVGIcons.MENU_ADVANCED_SETTINGS_RPC_NODE,
